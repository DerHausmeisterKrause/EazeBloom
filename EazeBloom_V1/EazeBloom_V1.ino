...
void handleRoot() {
  ...
  webpage += "<style>body { font-family: Arial, sans-serif; text-align: center; background-color: #f2f2f2; } .container { max-width: 800px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.1); } .logo { font-family: 'Courier New', Courier, monospace; } h2 { margin-top: 20px; font-family: 'Verdana', sans-serif; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); } .status { font-weight: bold; padding: 5px 10px; border-radius: 5px; margin-left: 10px; } .status-on { background-color: #4CAF50; color: white; } .status-off { background-color: #f44336; color: white; }</style></head><body>";
  ...
  webpage += "<div>";
  webpage += "<h2>Pumps</h2>";
  webpage += "<p>Pump 1 Status: <span class=\"status status-" + String(pump1Status ? "on\">ON" : "off\">OFF") + "</span><br>";
  webpage += "Pump 2 Status: <span class=\"status status-" + String(pump2Status ? "on\">ON" : "off\">OFF") + "</span></p>";
  webpage += "</div>";
